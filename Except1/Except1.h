...
public:
	...
	void ClearOutWnd();
	void LogError(const CString& errorMessage);
	void DisplayErrorMessage(const CString& errorMessage);
// Overrides
public:
...
class EXCEPT1_API MyExcept1
{
public:
	void HandleError(const CString& errorMessage);
	void LogError(const CString& errorMessage);
};
